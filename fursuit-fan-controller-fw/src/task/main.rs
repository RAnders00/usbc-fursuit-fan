...
use embassy_stm32::{
    peripherals::{PA1, PA2, PA3, PA6, PA7, TIM2, TIM3},
...
static STATES: [State; 11] = [
    State::new(5, 55, 255, 0, 0).with_brightness(LED_BRIGHTNESS), // red
    State::new(10, 40, 255, 40, 0).with_brightness(LED_BRIGHTNESS), // orange?
    State::new(20, 30, 255, 127, 0).with_brightness(LED_BRIGHTNESS), // yellow
    State::new(30, 10, 160, 255, 0).with_brightness(LED_BRIGHTNESS), // light green
